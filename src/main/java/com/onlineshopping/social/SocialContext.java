 ...
 */
package com.onlineshopping.social;
...
public class SocialContext implements ConnectionSignUp, SignInAdapter {
	...
	/**
	 * Use a random number generator to generate IDs to avoid cookie clashes between
	 * server restarts
	 */
	private static Random rand;

	/**
	 * Manage cookies - Use cookies to remember state between calls to the server(s)
	 */
